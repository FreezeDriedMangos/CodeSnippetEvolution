...
INSTRUCTIONS = {'a': (add, 'fb0'), # b means backwards (make negative), f means forwards (make positive), _ means ignore this argument
                'á': (add, 'ff0'), # 0 means use the same value as the first argument (1 means the second)
                'à': (add, 'bb0'), # in add, a = source1, b = source2, c = destination
                'å': (add, 'f+0'),
                's'
                'ś'
                '̀s' 
